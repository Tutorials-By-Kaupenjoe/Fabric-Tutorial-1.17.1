package net.gleason.tutorialmod.item.custom;

import com.google.common.collect.ImmutableMap;
import net.gleason.tutorialmod.item.ModArmorMaterial;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(ModArmorMaterial.RUBY, StatusEffects.INVISIBILITY).build();
