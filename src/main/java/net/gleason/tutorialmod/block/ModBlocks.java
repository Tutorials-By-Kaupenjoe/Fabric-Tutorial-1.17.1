package net.gleason.tutorialmod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.fabricmc.fabric.api.tool.attribute.v1.FabricToolTags;
import net.gleason.tutorialmod.TutorialMod;
import net.gleason.tutorialmod.block.custom.*;
import net.gleason.tutorialmod.item.ModItemGroup;
import net.gleason.tutorialmod.world.features.tree.RedwoodSaplingGenerator;
